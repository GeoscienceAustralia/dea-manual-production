...
#PBS -W umask=017
#PBS -q normal
#PBS -l walltime=8:00:00,mem=155GB,other=pernodejobfs
#PBS -l wd
...
INPUT_DIR='/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2020/'
...
for i in $(seq  $START $END);
    ...
    do echo 2020-05-$i 2020-05-$(($i+1)) $INPUT_DIR $OUTPUT_DIR ;
