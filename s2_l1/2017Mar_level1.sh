...
# Look for missing date on 23 Jan 2017 which has written to Mar folder

INPUT_DIR='/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2017/'
...
for i in $(seq  $START $END);
    ...
    do echo 2017-03-$i 2017-03-$(($i+1)) $INPUT_DIR $OUTPUT_DIR ;
